...
- [コードを見る (github.com)](https://github.com/ryukau/filter_notes/tree/master/dr110_cymbal/demo)
...
<figure>
<img src="img/DR-110.svg" alt="Image of signal flow of DR-110 cymbal." style="width: 720px; padding-bottom: 12px;"/>
</figure>
...
<figure>
<img src="img/DR-110_osc.svg" alt="Image of signal flow of DR-110 cymbal oscillator." style="width: 360px; padding-bottom: 12px;"/>
</figure>
...
<figure>
<img src="img/osc_crop.png" alt="Image of oscillator section of DR-110 schematic." style="width: 480px; padding-bottom: 12px;"/>
</figure>
...
<figure>
<img src="img/dr110_bp0.svg" alt="Image of DR-110 band-pass filter schematic." style="width: 480px; padding-bottom: 12px;"/>
</figure>
...
<figure>
<img src="img/dr110_bandpass_bode.png" alt="Image of Bode plot of DR-110 band-pass filter." style="width: 480px; padding-bottom: 12px;"/>
</figure>
...
<figure>
<img src="img/env_crop.png" alt="Image of envelope section of DR-110 schematic." style="width: 600px; padding-bottom: 12px;"/>
</figure>

ハイパスフィルタの部分だけを抜き出した図です。

<figure>
<img src="img/dr110_highpass.svg" alt="Image of DR-110 high-pass filter schematic." style="width: 320px; padding-bottom: 12px;"/>
</figure>
...
<figure>
<img src="img/DR-110_high_metal.svg" alt="Image of signal flow of DR-110 high metal section." style="width: 600px; padding-bottom: 12px;"/>
</figure>

Low Metalはシンバルの音の低い部分の表現に使われるフィルタネットワークです。

<figure>
<img src="img/DR-110_low_metal.svg" alt="Image of signal flow of DR-110 low metal section." style="width: 520px; padding-bottom: 12px;"/>
</figure>

エンベロープの手前での周波数応答です。

<figure>
<img src="img/metal_filter.png" alt="Image of signal flow of DR-110 low metal section." style="width: 480px; padding-bottom: 12px;"/>
</figure>
...
<figure>
<img src="img/env_time_crop.png" alt="Image of specification of DR-110 cymbal envelopes." style="width: 320px; padding-bottom: 12px;"/>
</figure>

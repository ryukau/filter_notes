...
namespace {
   ...
   /// Li_3(x) for x in [-1,0]
   inline double li3_neg(double x) noexcept
   {
      const double cp[] = {
    ...
    inline double li3_pos(double x) noexcept
    {
       const double cp[] = {
 ...
 */
inline double Li3(double x) noexcept
{
 ...
 * @author Alexander Voigt
 */
inline std::complex<double> Li3(const std::complex<double>& z) noexcept
{
 ...
 * @author Alexander Voigt
 */
inline std::complex<long double> Li3(const std::complex<long double>& z) noexcept
{

...
namespace {
   ...
   inline bool is_finite(const std::complex<double>& z) noexcept
   {
      return std::isfinite(std::real(z)) && std::isfinite(std::imag(z));
   }

   /// complex logarithm, converts -0.0 to 0.0
   inline std::complex<double> clog(const std::complex<double>& z) noexcept
   {
   ...
   inline std::complex<double> Li_series(int64_t n, const std::complex<double>& z) noexcept
   {
   ...
   inline std::complex<double> Li_unity_pos(int64_t n, const std::complex<double>& z) noexcept
   {
   ...
   inline std::complex<double> stable_pow(const std::complex<double>& z, int64_t n) noexcept
   {
      if (std::imag(z) == 0) {
   ...
   /// Series expansion of Li_n(z) around z ~ 1, n < 0
   inline std::complex<double> Li_unity_neg(int64_t n, const std::complex<double>& z) noexcept
   {
      const std::complex<double> lnz = clog(z);
      const std::complex<double> lnz2 = lnz*lnz;
   ...
   inline std::complex<double> Li_rest(int64_t n, const std::complex<double>& z) noexcept
   {
      const std::complex<double> lnz = clog(-z);
      const std::complex<double> lnz2 = lnz*lnz;
 ...
 * arXiv:2010.09860].
 */
inline std::complex<double> Li(int64_t n, const std::complex<double>& z) noexcept
{

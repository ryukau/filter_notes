 ...
 * error of 2e-7.
 */
inline float Li2(float x) noexcept
{
 ...
 */
inline long double Li2(long double x) noexcept
{
 ...
 */
inline std::complex<float> Li2(const std::complex<float>& z) noexcept
{
   const float PI = 3.14159265f;
 ...
 * @note translated to C++ by Alexander Voigt
 */
inline std::complex<double> Li2(const std::complex<double>& z) noexcept
{
   const double PI = 3.1415926535897932;
 ...
 */
inline std::complex<long double> Li2(const std::complex<long double>& z) noexcept
{
   const long double PI = 3.14159265358979323846264338327950288L;

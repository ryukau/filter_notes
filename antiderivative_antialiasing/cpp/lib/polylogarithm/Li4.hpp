...
namespace {
   ...
   /// Li_4(x) for x in [-1,0]
   inline double li4_neg(double x) noexcept
   {
      const double cp[] = {
   ...
   inline double li4_half(double x) noexcept
   {
      const double cp[] = {
   ...
   inline double li4_mid(double x) noexcept
   {
      const double cp[] = {
   ...
   inline double li4_one(double x) noexcept
   {
 ...
 */
inline double Li4(double x) noexcept
{
   const double zeta2 = 1.6449340668482264;
   const double zeta4 = 1.0823232337111382;
 ...
 * @author Alexander Voigt
 */
inline std::complex<double> Li4(const std::complex<double>& z) noexcept
{
 ...
 * @author Alexander Voigt
 */
inline std::complex<long double> Li4(const std::complex<long double>& z) noexcept
{
